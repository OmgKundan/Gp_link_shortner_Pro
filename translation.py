...
START_MESSAGE = '''**Hello, {}
I Am gplinks.in, Bulk Link Converter. I Can Convert Links Directly From Your gpLinks Account,
    
1. Go To 👉 https://gplinks.in
2. Than Copy API Key
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of Shortnerfly than **contact** at 👉 @OMG~KUNDAN (all **shortners** support available.)
'''

HELP_MESSAGE = '''**Hello, {}
I Am gpLinks, Bulk Link Converter Bot. I Can Convert Links Directly From Your ShortnerFly Account,**
